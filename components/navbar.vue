<template>
  <div class="bg-[#28574e] flex items-center justify-between px-4 py-4 fixed z-50 w-full">
    ...
    <transition name="slide">
      <div v-if="isSidenavOpen" class="fixed inset-0 bg-[#28574e] text-[#28574e] bg-opacity-50 z-50" @click="toggleSidenav">
        <aside class="w-64 bg-gray-200  p-4 fixed inset-y-0 left-0 top-0" @click.stop>
          ...
          <nav>
            <ul>
              <li class="mb-2">
                <a href="/" class="border border-[#28574e] rounded-md block py-2 px-4 hover:bg-gray-400 ">Home</a>
              </li>
              <li class="mb-2">
                <div @click="toggleDropdown('orders')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400 ">
                  <span>Orders</span>
              ...
              <li class="mb-2">
                <div @click="toggleDropdown('products')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400 ">
                  <span>Products</span>
              ...
              <li class="mb-2">
                <div @click="toggleDropdown('customers')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400 ">
                  <span>Customers</span>
              ...
              <li class="mb-2">
                <div @click="toggleDropdown('content')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400">
                  <span>Content</span>
              ...
              <li class="mb-2">
                <div @click="toggleDropdown('analytics')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400 ">
                  <span>Analytics</span>
              ...
              <li class="mb-2">
                <div @click="toggleDropdown('marketing')" class="border border-[#28574e] rounded-md flex justify-between items-center cursor-pointer py-2 px-4 hover:bg-gray-400 ">
                  <span>Marketing</span>
              ...
              <li class="mb-2">
                  <a href="#" class="border border-[#28574e] rounded-md block py-2 px-4 hover:bg-gray-400">Discounts</a>
              </li>
