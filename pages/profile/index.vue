  ...
  <div class="">
    <div class="mx-auto max-w-2xl px-4">
      <div class="rounded-lg p-6">
        ...
        >
          <p class="text-sm">
            <strong>Note:</strong> If you are a new user, please continue by
            setting your password (you need to write your password in both the
            fields i.e. the current password and new password).
          </p>
        </div>
