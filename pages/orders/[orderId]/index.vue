<template>
  <div class="flex flex-col min-h-screen py-10 px-4 lg:px-20 bg-gray-100" v-if="order" >
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
      ...
      <div v-if="loading" class="text-center text-gray-600">Loading order details...</div>
      ...
      <nuxt-link
        :to="`/orders/${order.id}/fulfill`"
        class="bg-blue-500 text-white font-semibold px-2 py-1 rounded-md shadow-gray-800"
      >
        Fulfill Items
      </nuxt-link>
