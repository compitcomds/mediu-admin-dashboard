<template>
  <AttachSidebar>
    <!-- Welcome Section -->
    <div
      class="bg-white flex flex-col shadow-2xl rounded-xl p-12 mb-10 items-center space-y-6 w-full text-[#28574e]"
    >
      <img
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 w-full mb-16">
      <div
        class="bg-gradient-to-r from-green-200 to-white shadow-xl rounded-lg p-10 flex flex-col items-center transition transform hover:scale-105 hover:shadow-2xl"
      >
      ...
      <div
        class="bg-gradient-to-r from-blue-200 to-white shadow-xl rounded-lg p-10 flex flex-col items-center transition transform hover:scale-105 hover:shadow-2xl"
      >
      ...
      <div
        class="bg-gradient-to-r from-indigo-200 to-white shadow-xl rounded-lg p-10 flex flex-col items-center transition transform hover:scale-105 hover:shadow-2xl"
      >
    ...
    <!-- Recent Orders -->
    <div
      class="bg-white shadow-2xl rounded-xl p-12 w-full mb-16 overflow-x-auto"
    >
      ...
      <table class="min-w-full bg-white rounded-lg">
        ...
        <tbody>
          <tr class="hover:bg-gray-100 transition">
            ...
            <td
              class="py-4 px-6 text-green-800 font-semibold whitespace-nowrap"
            >
              Completed
            </td>
          ...
          <tr class="hover:bg-gray-100 transition">
            ...
            <td
              class="py-4 px-6 text-yellow-800 font-semibold whitespace-nowrap"
            >
              Pending
            </td>
