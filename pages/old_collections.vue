    ...
    <div class="flex flex-col h-screen py-10 lg:py-5">
        ...
        <div class="lg:ml-64 flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 mt-4 bg-gray-100">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0">
                ...
                <nuxt-link to="/createCollection" class="bg-black text-white px-2 md:px-3 py-1.5 rounded-md lg:ml-4">
                    Create Collection
                </nuxt-link>
            </div>
            ...
            products: [
                {
                    ...
                    desc: "Excluded from 3 sales channels",
                    hover: "Excluded from 3 sales channels",
                    inventory: "4",
                    vendor: "",
