    ...
    <div class="lg:ml-64 flex-1 overflow-y-auto p-8 mt-10 bg-gray-100">
      ...
      <div class="flex justify-between items-center mb-8 border-b pb-4">
        ...
        <div class="flex space-x-4">
          <button @click="$router.push('/product')" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md">Discard</button>
          <button @click="addProduct" class="bg-blue-600 text-white px-4 py-2 rounded-md">Save</button>
        </div>
      </div>
      <div class="space-y-8">
        <div class="bg-white p-6 rounded-xl shadow-md space-y-8">
          ...
          <div>
            ...
            <label class="block text-sm font-medium text-gray-700 mt-6">Description</label>
          ...
          <div class="bg-white p-6 rounded-xl shadow-md">
            ...
            <div class="mt-4 flex items-center">
              <input id="tax-checkbox" name="tax-checkbox" type="checkbox" class="h-4 w-4 text-blue-600 border-gray-300 rounded" />
            ...
            <div>
              ...
              <div class="mt-1">
                <div class="flex items-center">
                  <input id="track-quantity" name="track-quantity" type="checkbox"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded"  required/>
                  <label for="track-quantity" class="ml-2 block text-sm text-gray-900">Track quantity</label>
                </div>
                <div class="mt-4">
                  <label class="block text-sm font-medium text-gray-500">Stock Quantity</label>
                  <input v-model="newProduct.quantity" id="quantity"  type="number"
                    class="block w-full border p-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
